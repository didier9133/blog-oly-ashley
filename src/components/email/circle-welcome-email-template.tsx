...
export default function CircleWelcomeEmailTemplate({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Welcome to Rebuilding Reverence Circle. Here are your community and
        journal links.
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={bodyText}>
            Welcome to Rebuilding Reverence Circle. I&apos;m so glad you&apos;re
            here.
          </Text>
          <Text style={bodyText}>
            Over the next four weeks, we&apos;re going to reclaim reverence
            together - not the fear-based, performance-based version many of us
            were handed, but something rooted, honest, and yours. This is a
            space for asking real questions, not performing certainty. If
            you&apos;ve felt caught between the faith you were given and the
            faith you&apos;re still building, you&apos;re exactly who this is
            for.
          </Text>
          ...
          <Section style={steps}>
            ...
            <Text style={stepText}>
              ...
              included with your purchase, this is your companion for the next
              four weeks.
            </Text>
            ...
            <Text style={stepText}>
              ...
              Reverence Circle begins once we reach 15 members. As soon as we
              hit that number, you&apos;ll receive an email with your official
              start date, along with at least 2 weeks&apos; notice before our
              first session.
            </Text>
          </Section>
          <Text style={bodyText}>
            A few honest words before we begin: this isn&apos;t a space where I
            hand you resolved answers. It&apos;s a space where we sit in the
            real tension together - faith and doubt, structure and freedom,
            belonging and becoming - and figure out what&apos;s actually true
            for you, not just what you were told was true.
          </Text>
          <Text style={bodyText}>
