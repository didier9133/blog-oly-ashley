...
import {
  CIRCLE_CAPACITY,
  CIRCLE_EARLY_PRICE,
  CIRCLE_REGULAR_PRICE,
  CIRCLE_SPOTS_REMAINING,
} from "@/lib/circle-config";

const PRICE_CENTS = CIRCLE_EARLY_PRICE * 100;
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: fullUrl(locale, "/circle/reserve") },
  };
}
...
export default async function ReservePage({
  ...
  const regularPrice = CIRCLE_REGULAR_PRICE.toFixed(0);
  ...
  return (
    <>
      ...
      <div className="font-[family-name:var(--font-cormorant-garamond)] bg-[#F9F8F6]">
        <section
          id="reserve"
          className="bg-[#f5f0eb] pt-32 sm:pt-40 pb-16 lg:pb-24"
        >
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-3xl sm:text-4xl font-light text-foreground mb-3">
                    {CIRCLE_SPOTS_REMAINING === 0
                      ? t("cohort-status.waitlist")
                      : t("cohort-status.spotsRemaining", {
                          count: CIRCLE_SPOTS_REMAINING,
                          total: CIRCLE_CAPACITY,
                        })}
                  </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-baseline gap-3">
                    <span className="text-4xl font-light text-foreground italic">
                      ${price}
                    </span>
